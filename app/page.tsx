  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-57px)] flex-col items-center justify-center px-4">
      <div className="text-center mb-16">
        ...
        <h1 className="text-6xl md:text-8xl font-normal tracking-tight text-white mb-6" style={{ fontFamily: 'var(--font-instrument-serif)' }}>
          POLARITY
        </h1>
        <p className="text-xl text-neutral-400 max-w-lg mx-auto leading-relaxed">
          Prove you&apos;re right or destroy your logic. <span className="text-green-400">The AI that picks a side.</span>
        </p>
      </div>
