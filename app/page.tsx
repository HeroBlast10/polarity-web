    ...
    <div className="container mx-auto flex min-h-[calc(100vh-57px)] flex-col items-center justify-center px-4 py-6 md:py-8">
      ...
      <div className="mb-5 flex flex-col items-center gap-2 text-center md:mb-6">
        <Button
          ...
          className="rounded-full bg-white px-6 py-5 text-black hover:bg-neutral-200"
        >
      ...
      <div className="grid w-full max-w-3xl grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
        <Link href="/settings?redirect=chat" className="group">
          <Card className="h-full border border-neutral-800 bg-card transition-all duration-500 hover:border-green-500/30 hover:bg-neutral-900/50 cursor-pointer">
            <CardContent className="flex flex-col items-center justify-center p-8 text-center md:p-9">
              <div className="mb-4 rounded-full bg-green-500/5 p-4 group-hover:bg-green-500/10 transition-colors">
                <MessageSquare className="h-6 w-6 text-green-500" />
              </div>
              <h2 className="mb-2 text-xl font-medium text-white md:text-2xl" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                Single Chat
              </h2>
              <p className="mb-5 text-sm leading-relaxed text-neutral-400 md:text-base">
        ...
        <Link href="/settings?redirect=chat" className="group">
          <Card className="h-full border border-neutral-800 bg-card transition-all duration-500 hover:border-red-500/30 hover:bg-neutral-900/50 cursor-pointer">
            <CardContent className="flex flex-col items-center justify-center p-8 text-center md:p-9">
              <div className="mb-4 rounded-full bg-red-500/5 p-4 group-hover:bg-red-500/10 transition-colors">
